...
public static final Object uncons = (java.util.function.Function<Object, Object>) (v_0) -> ( ((Boolean) (java.util.Objects.equals(v_0, ""))) ? new Data_Maybe.Nothing() : new Data_Maybe.Just((new java.util.function.Supplier<Object>() { public Object get() { java.util.Map<String, Object> __map = new java.util.LinkedHashMap<>(); __map.put("head", ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_String_Unsafe.charAt)).apply(new Integer(0)))).apply(v_0)); __map.put("tail", ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_String_CodeUnits.drop)).apply(new Integer(1)))).apply(v_0));  return __map; } }).get()));
...
public static final Object startsWith = (java.util.function.Function<Object, Object>) (pat_0) -> (java.util.function.Function<Object, Object>) (x_1) -> { Object __local_var_2 = ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_String_CodeUnits.stripPrefix)).apply(pat_0))).apply(x_1); return ( ((Boolean) ((__local_var_2 instanceof Data_Maybe.Nothing))) ? new Boolean(false) : ( ((Boolean) ((__local_var_2 instanceof Data_Maybe.Just))) ? new Boolean(true) : (new java.util.function.Supplier<Object>() { public Object get() { throw new RuntimeException("Failed pattern match"); } }).get())); };
...
public static final Object endsWith = (java.util.function.Function<Object, Object>) (pat_0) -> (java.util.function.Function<Object, Object>) (x_1) -> { Object __local_var_2 = ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_String_CodeUnits.stripSuffix)).apply(pat_0))).apply(x_1); return ( ((Boolean) ((__local_var_2 instanceof Data_Maybe.Nothing))) ? new Boolean(false) : ( ((Boolean) ((__local_var_2 instanceof Data_Maybe.Just))) ? new Boolean(true) : (new java.util.function.Supplier<Object>() { public Object get() { throw new RuntimeException("Failed pattern match"); } }).get())); };
