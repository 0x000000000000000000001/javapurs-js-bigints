...
public static final Object runStore = (java.util.function.Function<Object, Object>) (v_0) -> { Object __local_var_1 = (new java.util.function.Supplier<Object>() { public Object get() { Object __local_var_1 = new Data_Tuple.Tuple((((Data_Tuple.Tuple) v_0).value1), (((Data_Tuple.Tuple) v_0).value0)); return new Data_Tuple.Tuple((((Data_Tuple.Tuple) __local_var_1).value0), (((Data_Tuple.Tuple) __local_var_1).value1)); } }).get(); return new Data_Tuple.Tuple((((Data_Tuple.Tuple) __local_var_1).value1), (((Data_Tuple.Tuple) __local_var_1).value0)); };
}
