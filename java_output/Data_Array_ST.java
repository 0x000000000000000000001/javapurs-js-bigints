...
public static final Object withArray = (java.util.function.Function<Object, Object>) (f_0) -> (java.util.function.Function<Object, Object>) (xs_1) -> ((java.util.function.Function<Object, Object>) (Data_Array_ST.thawImpl)).apply(xs_1);
...
public static final Object sortBy = (java.util.function.Function<Object, Object>) (comp_0) -> ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Control_Monad_ST_Uncurried.runSTFn3)).apply(Data_Array_ST.sortByImpl))).apply(comp_0))).apply((java.util.function.Function<Object, Object>) (v_1) -> ( ((Boolean) ((v_1 instanceof Data_Ordering.GT))) ? new Integer(1) : ( ((Boolean) ((v_1 instanceof Data_Ordering.EQ))) ? new Integer(0) : ( ((Boolean) ((v_1 instanceof Data_Ordering.LT))) ? new Integer(-1) : (new java.util.function.Supplier<Object>() { public Object get() { throw new RuntimeException("Failed pattern match"); } }).get()))));
...
public static final Object run = (java.util.function.Function<Object, Object>) (st_0) -> ((java.util.function.Function<Object, Object>) (Control_Monad_ST_Internal.run)).apply(st_0);
...
public static final Object modify = (java.util.function.Function<Object, Object>) (i_0) -> (java.util.function.Function<Object, Object>) (f_1) -> (java.util.function.Function<Object, Object>) (xs_2) -> ((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_Array_ST.peekImpl)).apply(Data_Maybe.Just))).apply(new Data_Maybe.Nothing()))).apply(i_0))).apply(xs_2);
